...
- [AI Security Agent for Smart Contract Audit Automation](https://github.com/MukeshJaiswal01/AI-Security-Projects/blob/main/ai_security_projects_readme.md#2-ai-security-agent-for-smart-contract-audit-automation) (Agent based security research assistant)
